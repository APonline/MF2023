...
@Component({
  selector: 'app-merchForm',
  templateUrl: './merch-form.component.html',
  styleUrls: ['./merch-form.component.scss']
 })
export class MerchFormComponent implements OnInit, OnChanges {
  ...
  setSettings(formData){
    ...
    newForm['description'] = '';
    this.displayedColumns.push('in_stock');
    form['in_stock'] = new FormControl('');
    newForm['in_stock'] = '';
    this.displayedColumns.push('sizes');
    form['sizes'] = new FormControl('');
    newForm['sizes'] = '';
    this.displayedColumns.push('main_image_url');
    form['main_image_url'] = new FormControl('');
    newForm['main_image_url'] = '';
