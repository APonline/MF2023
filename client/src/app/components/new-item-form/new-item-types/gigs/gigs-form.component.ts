...
@Component({
  selector: 'app-gigsForm',
  templateUrl: './gigs-form.component.html',
  styleUrls: ['./gigs-form.component.scss']
 })
export class GigsFormComponent implements OnInit, OnChanges {
  ...
  setSettings(formData){
    ...
    form['event'] = new FormControl('');
    newForm['event'] = '';
    this.displayedColumns.push('day');
    form['day'] = new FormControl('');
    newForm['day'] = '';
    this.displayedColumns.push('show_timw');
    form['show_timw'] = new FormControl('');
    newForm['show_timw'] = '';
    this.displayedColumns.push('location');
    form['location'] = new FormControl('');
    newForm['location'] = '';
    this.displayedColumns.push('tickets_url');
    form['tickets_url'] = new FormControl('');
    newForm['tickets_url'] = '';
